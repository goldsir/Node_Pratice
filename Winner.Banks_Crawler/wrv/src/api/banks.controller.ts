...
export class BanksController {
    ...
    constructor(
        ...
        , private readonly tpBankService: TPBankService
        , private readonly vietinBankService: VietinBankService
    ) {
    ...
    async open(@Req() req, @Res() res, @Param() params: Bank) {
        ...
        switch (params.BankName) {
            ...
            case 'BIDVBank':
                ...
                break;
            case 'TPBank':
                this.tpBankService.openBank(bank);
                break;
            case 'VietinBank':
                this.vietinBankService.openBank(bank);
                break;
            default:
                return res.json({
                    resultCode: 1
